...
<html lang="en">
    <head>
        ...
        <title>Instashare - Administração</title>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="/"><img src="../../../wp-content/uploads/2017/12/IMG-20171213-WA0053.png" style="height: 20px; width: auto;"></a>
                </div>
                ...
                <ul class="nav navbar-right navbar-top-links">
                            ...
                            <li>
                                <a href="#">
                                    <div>
                                        ...
                                        <span class="pull-right text-muted small">4 dias atrás</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <div>
                                        ...
                                        <span class="pull-right text-muted small">12 dias atrás</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i> Admin1 <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="#"><i class="fa fa-user fa-fw"></i> Preferências</a>
                            </li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="/" class="active"><i class="fa fa-dashboard fa-fw"></i> Geral</a>
                            </li>
                            <li>
...
<li ><a href="#" onclick="esta_visualiza_pag()">Visualizações de página</a></li>
                            ...
                            <li>
<a href="#" class="active"><i class="fa fa-sitemap"></i> Cadastros<span class="fa arrow"></span></a>


<ul><li><a href="#" class="active"><i class="fa fa-sitemap"></i> Usuários Cadastrados</a></li>

    <li><a href="#" class="active"><i class="fa fa-sitemap"></i> Anúncios Cadastrados</a></li>
   <li><a href="#" class="active" onclick="link('parceiros')"><i class="fa fa-sitemap"></i> Parceiros</a></li>
</ul>
...
echo listagem("logs_ff", "data::hora::usuario::log::franquia", "order by um desc limit 10");
 ...
 ?>
                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        <i class="fa fa-comment fa-fw"></i> Novas Avaliações
                                            <span class="pull-right text-muted small"><em>4 dias atrás</em>
                                            </span>
                                    </a>
                                    ...
                                    <a href="#" class="list-group-item">
                                        <i class="fa fa-warning fa-fw"></i> Reclamações
                                            <span class="pull-right text-muted small"><em>6 dias atrás</em>
                                            </span>
                                    </a>
                                  
                                    <a href="#" class="list-group-item">
                                        <i class="fa fa-money fa-fw"></i> Pagamento
                                            <span class="pull-right text-muted small"><em>7 dias atrás</em>
                                            </span>
                                    </a>
                                </div>
                                <!-- /.list-group -->
                                <a href="#" class="btn btn-default btn-block">Ver tudo</a>
                            </div>
                            <!-- /.panel-body -->
                        </div>
                        <!-- /.panel -->
                        <div class="panel panel-default" style="display: none">
                            <div class="panel-heading">
                                <i class="fa fa-bar-chart-o fa-fw"></i> Negociações Iniciadas
                            </div>
                            <div class="panel-body">
                                <div id="morris-donut-chart"></div>
                                <a href="#" class="btn btn-default btn-block">Mais Detalhes</a>
                            </div>
                            <!-- /.panel-body -->
                        </div>
                        <!-- /.panel -->
                            ...
                            <div class="panel-body" style="display:none;">
                                <ul class="chat">
                                    <li class="left clearfix">
                                        ...
                                        <div class="chat-body clearfix" style="display: none;">
                                            <div class="header">
        ...
        <!-- Morris Estatísticas JavaScript -->
