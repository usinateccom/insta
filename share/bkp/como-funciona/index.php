...
<title>Instashare.ME - Como Funciona</title>
...
<h2>Como funciona o Instashare</h2>
			...
			<div class="section-overlay-layer">
				<div class="container">
					...
					<div class="section-header">
						<h2 class="dark-text">Como funciona</h2><div class="colored-line"></div>
						<div class="sub-heading">Veja o vídeo abaixo:</div>					</div></div></div></section>
<!-- =========================
 SECTION: BRIEF LEFT
============================== -->
		<section class="brief text-left brief-design-one brief-left" id="story">
			
<center>[INSERIR VIDEO]</center>
