    ...
    <footer class="footer grey-bg">
        ...
        <div class="container">
	        ...
	        <div class="powered-by">
	            <a class="" href="https://themeisle.com/themes/parallax-one/" target="_blank" rel="nofollow">Parallax One </a> <?php esc_html_e('powered by','parallax-one'); ?> <a class="" href="https://wordpress.org/" target="_blank" rel="nofollow"><?php esc_html_e('WordPress','parallax-one'); ?></a>
	        </div>
