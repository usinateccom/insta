<div class="encaixa">
				...
				<!-- SECTION HEADER -->
						...
						<h2 class="dark-text">Avaliações</h2><div class="colored-line"></div><div class="sub-heading"><h3 class="rukio">Veja o que os membros dizem sobre o Instashare</h3></div>					</div>
