...
class BP_XProfile_Field_Type_Datebox extends BP_XProfile_Field_Type {
	 ...
	 *                              {@link httpss://dev.w3.org/html5/markup/input.html permitted attributes}
			...
			<td>
				<fieldset>
					...
					<div class="bp-date-format-option">
						...
						<p><a href="httpsss://codex.wordpress.org/Formatting_Date_and_Time"><?php esc_html_e( 'Documentation on date and time formatting', 'buddypress' ); ?></a></p>
					</div>
