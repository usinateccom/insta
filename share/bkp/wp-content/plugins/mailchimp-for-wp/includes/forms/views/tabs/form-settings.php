...
<table class="form-table" style="table-layout: fixed;">
	...
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php _e( 'Leave empty or enter <code>0</code> for no redirect. Otherwise, use complete (absolute) URLs, including <code>https://</code>.', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
