...
class VideoPress_Player {
	...
	private function html_age_gate() {
		...
		$html .= '</fieldset>';
		$html .= '<p style="padding-top:20px;padding-bottom:60px;text-align:' . $text_align . ';"><a rel="nofollow" href="https://videopress.com/" target="_blank" style="color:rgb(128,128,128);text-decoration:underline;font-size:15px">' . __( 'More information', 'jetpack' ) . '</a></p>';
	 ...
	 *
	 * @since 1.2
	 * @link https://www.whatwg.org/specs/web-apps/current-work/multipage/video.html HTML5 video
	...
	private function html5_static() {
		...
		if ( isset( $this->options['freedom'] ) && $this->options['freedom'] === true )
			$html .= '<p class="robots-nocontent">' . sprintf( __( 'You do not have sufficient <a rel="nofollow" href="%s" target="_blank">freedom levels</a> to view this video. Support free software and upgrade.', 'jetpack' ), 'https://www.gnu.org/philosophy/free-sw.html' ) . '</p>';
	...
	private function html5_dynamic() {
		...
		if ( $age_gate_required ) {
			...
			/**
			 * @link https://code.google.com/p/swfobject/wiki/api#swfobject.embedSWF(swfUrlStr,_replaceElemIdStr,_widthStr,_height
			 */
	 ...
	 *
	 * @since 1.2
	 * @link https://kb2.adobe.com/cps/127/tn_12701.html Flash object and embed attributes
	 * @link https://kb2.adobe.com/cps/133/tn_13331.html devicefont
	 * @link https://kb2.adobe.com/cps/164/tn_16494.html allowscriptaccess
	 * @link https://www.adobe.com/devnet/flashplayer/articles/full_screen_mode.html full screen mode
	 * @link https://livedocs.adobe.com/flash/9.0/main/wwhelp/wwhimpl/common/html/wwhelp.htm?context=LiveDocs_Parts&file=00001079.html allownetworking
	 ...
	 * @link https://www.google.com/support/reader/bin/answer.py?answer=70664 Google Reader markup support
	...
	private function flash_object() {
		...
		$flash_help = sprintf( __( 'This video requires <a rel="nofollow" href="%s" target="_blank">Adobe Flash</a> for playback.', 'jetpack' ), 'https://www.adobe.com/go/getflashplayer');
