...
function jetpack_verification_tool_box() {
	...
	if ( current_user_can( 'manage_options' ) ) {
		echo '<div class="jp-verification-tools card"><h3 class="title">' . __( 'Website Verification Services' , 'jetpack' ) . ' <a href="https://support.wordpress.com/webmaster-tools/" target="_blank">(?)</a></h3>';
