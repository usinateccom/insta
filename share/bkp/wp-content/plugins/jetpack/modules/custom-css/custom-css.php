			...
			<form id="safecssform" action="" method="post">
				...
				<div id="poststuff">
					...
					<?php
						 ...
						 */
						echo apply_filters( 'safecss_intro_text', __( 'New to CSS? Start with a <a href="https://www.htmldog.com/guides/cssbeginner/" target="_blank">beginner tutorial</a>. Questions?
