...
<span class='tuno' style='margin-top: 16px;'>

<img src='$ponto"."imagens/localizacao aluguel compartilhar carro.png' style='margin-top: 0px;'> <div style='margin-top: 8px; margin-bottom:-6px; display:inline;'> - $bairro</div>
...
<a href="<?php echo $ponto; ?>anuncios/" title="<?php echo $tit_u; ?> - Anúncios" alt="<?php echo $alt_u; ?>" class="anuncio_bloco" style="color:#fff;">
