...
<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Metatags e Conteúdo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
echo "  <a href='#' onclick=".'"'."loa('$arraylandia')".'"'." class='pulim'><i class='fa fa-table fa-fw'></i> ".cresce($fon["qual_e"])."</a><br>";
...
<br><br><button class='btn btn-primary' id='steie' onclick='bolacha()'>INSERIR META-TAGS</button>
